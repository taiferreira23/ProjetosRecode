...
<head>
  ...
  <title>PromoÃ§Ãµes-Darling Viagens- Viaje com a melhor!</title>
...
<div class="espaco d-flex justify-content-center"><!--separaÃ§Ã£o do footer-->
<div class="espaco-branco">

  <h2 class="centro1">As melhores promos você encontra aqui!</h2>

...
<div class="espaco d-flex justify-content-center">
  <div class="espaco-branco c">
    <h1 class="centro1">Entre em contato conosco através do seu email!</h1>
    <br>
...
<div class="d-flex justify-content-center">
  <h4 class="centro1">Nossas redes sociais!</h4>
</div>
 ...
 <div class="container-fluid "><!-- footer -->
    <footer class="rodape d-flex justify-content-center align-items-center py-3 my-4">
      <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="mb-3 mb-md-0 centro">Â© 2022 Company, Inc</span>
      </div>
